...
import { getVendorPerformance } from "@/app/actions/performance"
          ...
          <Card className="border border-border rounded-3xl p-6 text-center space-y-5 shadow-sm">
            ...
            <div className="space-y-1.5">
              ...
              <CardDescription className="max-w-[280px] mx-auto">
                Please log in to your vendor/brand account to view performance analytics.
              </CardDescription>
            </div>
            <Button className="w-full h-11 shadow-md shadow-primary/10" render={<Link href="/login?callbackURL=/vendor/performance" />}>
              Sign In as Vendor
            </Button>
          </Card>
        </main>
    ...
    <div className="flex min-h-screen flex-col bg-muted/30">
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-8 sm:px-6 lg:px-8">
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Track your store metrics, vendor score, and product performance.
              </p>
            </div>
          ...
          {/* Client Dashboard */}
          <VendorPerformanceClient initialData={result} />
        </div>
      </main>
      <SiteFooter />
    </div>
