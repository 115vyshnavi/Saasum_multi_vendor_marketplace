...
import { Truck, ShieldAlert, ArrowLeft, AlertTriangle, CheckCircle2, Clock } from "lucide-react"
import { getAdminShipments } from "@/app/actions/logistics"
import { SiteNavbar } from "@/components/site-navbar"
import { SiteFooter } from "@/components/site-footer"
import { Button } from "@/components/ui/button"
import { Card, CardDescription, CardTitle } from "@/components/ui/card"
import { AdminLogisticsClient } from "./admin-logistics-client"
          ...
          <Card className="border border-border rounded-3xl p-6 text-center space-y-5 shadow-sm">
            ...
            <div className="space-y-1.5">
              ...
              <CardDescription className="max-w-[280px] mx-auto">
                Please log in as an administrator to manage marketplace logistics.
              </CardDescription>
            </div>
            <Button className="w-full h-11 shadow-md shadow-primary/10" render={<Link href="/login?callbackURL=/admin/logistics" />}>
              Sign In as Admin
            </Button>
          </Card>
        </main>
    ...
    <div className="flex min-h-screen flex-col bg-muted/30">
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 px-4 py-8 sm:px-6 lg:px-8">
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Monitor all marketplace shipments, track delays, and manage courier operations.
              </p>
            </div>
          ...
          {/* Client Panel */}
          <AdminLogisticsClient initialShipments={result.shipments || []} />
        </div>
      </main>
      <SiteFooter />
    </div>
